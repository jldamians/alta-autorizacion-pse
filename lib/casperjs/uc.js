...
var IDENTITY = casper.cli.get("identity"),
    USERNAME = casper.cli.get("username"),
    PASSWORD = casper.cli.get("password"),
    PERIODO_TRIBUTARIO = casper.cli.get("period"),
    VENTAS_GRAVADAS_NETAS = casper.cli.get("sales"),
    COMPRAS_GRAVADAS_NETAS = casper.cli.get("purchases"),
    INGRESOS_NETOS = casper.cli.get("income"),
    IMPORTE_PAGAR = casper.cli.get("payment"),
    RUTA_CONSTANCIA = casper.cli.get("path");
